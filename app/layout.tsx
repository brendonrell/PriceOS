...
<style>
  ...
  /* The SVG rotates. The wrapper just handles position for the exit. */
  #pd-loader-svg {
    width: 72px; height: 72px;
    color: #FFE600;
    animation: pdSpin 0.75s linear infinite;
    will-change: transform;
  }
</style>
<div id="pd-loader">
  <div id="pd-loader-wrap" style="position:relative;width:72px;height:72px;">
    <svg id="pd-loader-svg" viewBox="0 0 761 655" fill="none" xmlns="http://www.w3.org/2000/svg">
