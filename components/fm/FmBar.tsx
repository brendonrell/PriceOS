...
export default function FmBar() {
    ...
    /* THE COMEBACK (Brendon, 2026-08-19: "why does it keep coming back?") —
       ...
       ⛔ REINSTATED 2026-08-22: this entire block was silently dropped in
       the Aug 22 upload, which is why the dead link came back AND why the
       player sat on pause on load — it was restoring that same dead
       station every time. Never remove this again. */
