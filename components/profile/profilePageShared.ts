...
export type ProfileMoreL1 = 'created' | 'starred' | 'wishlists' | 'albums' | 'offers' | 'vault' | 'sigil' | 'loyalty' | 'counterparties' | 'history' | 'info' | 'achievements' | 'discord' | 'anointed' | 'targets';
