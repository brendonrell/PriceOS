...
export type ProfileMoreL1 = 'cooldown' | 'created' | 'starred' | 'wishlists' | 'albums' | 'offers' | 'vault' | 'sigil' | 'loyalty' | 'artist' | 'counterparties' | 'history' | 'achievements' | 'discord' | 'anointed' | 'calls' | 'price-overview' | 'price-tokenomics' | 'price-contract' | 'price-utility';
