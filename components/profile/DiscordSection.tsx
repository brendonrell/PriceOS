...
/** Discord's brand mark — inline vector (no image asset). Exported so other
 *  surfaces (Counterparties' row glyph) share the one mark, themed via
 *  currentColor rather than Discord's blurple. */
export function DiscordLogo({ size = 18, className = '' }: { size?: number; className?: string }) {
    return (
