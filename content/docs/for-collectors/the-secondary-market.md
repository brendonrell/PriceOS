...
- **[Takeover](/docs/takeover) ⚑** — the blanket premium bid on another collector's entire position. Takeover offers ride the same book, wear a badge in the Offers tab, and cannot be withdrawn during their 72-hour window — enforceable precisely because the book is PD's own.
