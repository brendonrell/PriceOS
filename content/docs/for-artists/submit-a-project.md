...
1. **Whitelisting.** The factory admin whitelists your wallet on-chain (`PDFactory.whitelistArtist`). Deployment is impossible without it. This step is stealth — nothing about it appears anywhere public until you deploy; see [What's Private](/docs/whats-private).
