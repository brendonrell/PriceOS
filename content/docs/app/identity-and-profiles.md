...
category: "app"
keywords: ["identity", "@name", "pricesprite", "profile", "showcase", "albums"]
...
- **Showcase** — the owner's curated face: a top-six selection with four engine modes cycled by glyph — Static ⑆, Generative ⑇, Gen Curated ⑈ (auto-curates the collection into themed sets), and Artist ⑉ (for whitelisted artists with a released Project).
- **Collected** — every Output the wallet owns.
...
| Albums | ◰ | Public | Curated named sets within a Project |
