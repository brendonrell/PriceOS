...
| Category | Glyph | Territory |
| --- | --- | --- |
| Primary | ◍ | Minting |
| Trading | ⊟ | The secondary market |
| Social | ⊙ | Follows, mutuals, the graph |
| Projects | ⌗ | Engagement across bodies of work |
| Curation | ✦ | Taste made visible |
...
| Myth | ⍟ | The Odin arc — the platform's long mystery |
...
**PriceRank** (❂) is the platform's standing system. Achievements are one of its primary feeds — the grid is not just trophies, it's your record. The PriceRank surface in [Discovery](/docs/app/discovery) shows where that record places you.
