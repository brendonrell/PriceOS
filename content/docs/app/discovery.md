...
Time as a discovery surface — what minted when, what's minting now, what's marked ahead. Doubles as a [collector tool](/docs/app/collector-tools).

## Further reading

- [Projects & Minting](/docs/app/projects-and-minting)
- [Achievements](/docs/app/achievements)
- [The Shell](/docs/app/the-shell) — the Tape, discovery's live ticker
