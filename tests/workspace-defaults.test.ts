...
describe('shipped workspace defaults', () => {
    it('ships five, ids unique, names within the 24-char cap', () => {
        expect(SHIPPED_WORKSPACES.length).toBe(5);
    ...
    it('the four personas carry their flourish toasts; Main stays plain', () => {
