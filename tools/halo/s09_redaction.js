/* PROVENANCE — conceptual DOCUMENT art (window.ENGINE = 's09_redaction').
 * Bureaucratic paperwork as fine art: ledgers, forms, redaction bars, stamps,
 * price columns, dot-matrix numerals, carbon ghosting, hole-punches, signatures.
 * On Kawara / Hanne Darboven / institutional critique — dry, deadpan, elegant.
 * SURREAL = real-but-off: a ledger that REDACTS its own prices; a column of
 * figures summing to "‰" or "∞"; a valuation record for the unvaluable;
 * contradictory stamps; a price tag with no number. Never a joke.
 *
...
window.ENGINE = (function () {
  ...
  return { name: 's09_redaction', draw, traits };
})();
