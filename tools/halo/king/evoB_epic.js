/* K1 — PRISM
 * Refracted light through cut crystal, BRIGHT cyberpunk (Promare / Edgerunners).
 * A constellation of angular glass shards scattered OFF-CENTER on a luminous
 * holographic ground; each facet splits the palette into a different hue.
 * Refraction caustics ripple across the field, spectrum scatter fans off the
 * shard edges, light-leak bloom warms a corner, glyph/spectral dust whispers as
 * far texture. Sharp near-shards vs hazy far glow → layered depth, no centered gem.
 *
 * Motifs combined (per AESTHETIC.md §3): prismatic shards + refraction caustics
 * + light-leak bloom + glyph/spectral dust (far texture). NEVER a dark ground.
 */
