/* MURMURATION — a vast abstract swarm forming a shape over a hazy land.
 * Tens of thousands of tiny streaked elements (birds/seeds/drones) ride a
 * curl-noise flow-field across a moody twilight-steel sky, gathering toward a
 * suggestive attractor form (a wave, a swell, a vortex, a tilting ribbon),
 * dense at the heart and fraying at the edges — captured mid-motion with
 * directional streaking. Below: a low, hazy, cool abstract horizon with tiny
 * ground markers for scale. "Real but off" = the flock is too vast and too
 * organised, almost one organism.
 *
 * Territory: TWILIGHT STEEL + ONE HOT ACCENT. Slate / steel-blue / dusk-grey /
 * charcoal grounds, the FLOCK glowing in a single saturated accent. From afar:
 * "moody steel-blue sky with a vivid swarm." Grounds stay cool & desaturated so
 * the swarm pops. NOT synthwave, NOT cyberpunk, NOT pastel, NOT green land. */
