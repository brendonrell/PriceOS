...
const HEXAGRAMS: readonly Hexagram[] = [
  { n: 1, lower: QIAN, upper: QIAN, name: 'The Creative', fate: 'Sovereign' },
  { n: 2, lower: KUN, upper: KUN, name: 'The Receptive', fate: 'Yielding' },
  ...
  { n: 23, lower: KUN, upper: GEN, name: 'Splitting Apart', fate: 'Collapse' },
  { n: 24, lower: ZHEN, upper: KUN, name: 'Return', fate: 'Return' },
  { n: 25, lower: ZHEN, upper: QIAN, name: 'Innocence', fate: 'Innocence' },
  { n: 26, lower: QIAN, upper: GEN, name: 'Great Taming', fate: 'Bastion' },
  { n: 27, lower: ZHEN, upper: GEN, name: 'Nourishment', fate: 'Sustenance' },
  { n: 28, lower: XUN, upper: DUI, name: 'Great Excess', fate: 'Excess' },
  { n: 29, lower: KAN, upper: KAN, name: 'The Abysmal', fate: 'Abyss' },
  { n: 30, lower: LI, upper: LI, name: 'The Clinging Fire', fate: 'Radiance' },
  ...
  { n: 34, lower: QIAN, upper: ZHEN, name: 'Great Power', fate: 'Might' },
  { n: 35, lower: KUN, upper: LI, name: 'Progress', fate: 'Ascent' },
  { n: 36, lower: LI, upper: KUN, name: 'Darkening of the Light', fate: 'Eclipse' },
  { n: 37, lower: LI, upper: XUN, name: 'The Family', fate: 'Hearth' },
  ...
  { n: 42, lower: ZHEN, upper: XUN, name: 'Increase', fate: 'Bounty' },
  ...
  { n: 46, lower: XUN, upper: KUN, name: 'Pushing Upward', fate: 'Rising' },
  { n: 47, lower: KAN, upper: DUI, name: 'Oppression', fate: 'Adversity' },
  { n: 48, lower: XUN, upper: KAN, name: 'The Well', fate: 'Wellspring' },
  { n: 49, lower: LI, upper: DUI, name: 'Revolution', fate: 'Revolution' },
  { n: 50, lower: XUN, upper: LI, name: 'The Cauldron', fate: 'Cauldron' },
  { n: 51, lower: ZHEN, upper: ZHEN, name: 'The Arousing Thunder', fate: 'Thunder' },
  { n: 52, lower: GEN, upper: GEN, name: 'Keeping Still', fate: 'Stillness' },
  ...
  { n: 56, lower: GEN, upper: LI, name: 'The Wanderer', fate: 'Wanderer' },
  { n: 57, lower: XUN, upper: XUN, name: 'The Gentle Wind', fate: 'Whisper' },
  { n: 58, lower: DUI, upper: DUI, name: 'The Joyous Lake', fate: 'Joy' },
  { n: 59, lower: KAN, upper: XUN, name: 'Dispersion', fate: 'Dispersion' },
  { n: 60, lower: DUI, upper: KAN, name: 'Limitation', fate: 'Limit' },
