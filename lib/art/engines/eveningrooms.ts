// @ts-nocheck
/*
 * EveningRooms — PriceOS art engine (ported from the halo R&D engine
 * tools/halo/h4_eveningrooms.js). Continuous seed-driven surreal "real-but-off"
...
export const eveningRoomsTraits: TraitsFn = (tokenId) => ENGINE.traits(tokenId);
export const renderEveningRooms: EngineFn = blit((cv, tokenId) => ENGINE.draw(cv, tokenId), (tokenId) => ENGINE.traits(tokenId));
export const EVENINGROOMS_ASPECTS: readonly number[] = [0.8,1];
export const eveningRoomsSchema: TraitSchema = {
  "traits": [
    {
      "name": "Palette",
      "values": [
