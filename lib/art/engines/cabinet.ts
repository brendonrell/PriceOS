// @ts-nocheck
/*
 * Cabinet — PriceOS art engine (ported from the halo R&D engine
 * tools/halo/h4_cabinet.js). Continuous seed-driven surreal "real-but-off"
...
export const cabinetTraits: TraitsFn = (tokenId) => ENGINE.traits(tokenId);
export const renderCabinet: EngineFn = blit((cv, tokenId) => ENGINE.draw(cv, tokenId), (tokenId) => ENGINE.traits(tokenId));
export const CABINET_ASPECTS: readonly number[] = [0.8,1];
export const cabinetSchema: TraitSchema = {
  "traits": [
    {
      "name": "Palette",
      "values": [
