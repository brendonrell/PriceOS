// @ts-nocheck
/*
 * Tideworks — PriceOS art engine (ported from the halo R&D engine
 * tools/halo/gen/tideworks.js). Layout axis (4-6 structurally distinct
...
export const tideworksTraits: TraitsFn = (tokenId) => ENGINE.traits(tokenId);
export const renderTideworks: EngineFn = blit((cv, tokenId) => ENGINE.draw(cv, tokenId), (tokenId) => ENGINE.traits(tokenId));
export const TIDEWORKS_ASPECTS: readonly number[] = [1.3214,0.9516,1,1.4231,1.1186,0.9219];
export const tideworksSchema: TraitSchema = {
  "traits": [
    {
      "name": "Layout",
      "values": [
