// @ts-nocheck
/*
 * Vestment — PriceOS art engine (ported from the halo R&D engine
 * tools/halo/h4_vestment.js). Continuous seed-driven surreal "real-but-off"
...
export const vestmentTraits: TraitsFn = (tokenId) => ENGINE.traits(tokenId);
export const renderVestment: EngineFn = blit((cv, tokenId) => ENGINE.draw(cv, tokenId), (tokenId) => ENGINE.traits(tokenId));
export const VESTMENT_ASPECTS: readonly number[] = [0.782,1];
export const vestmentSchema: TraitSchema = {
  "traits": [
    {
      "name": "Palette",
      "values": [
