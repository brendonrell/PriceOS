...
export const MOCK_NOTES: NoteItem[] = [
    ...
    { id: '#2121', icon: '⊟\uFE0E', text: 'Mirror pattern, nice Output to show' },
    { id: '#2200', icon: '⊟\uFE0E', text: 'Closing in on final 22, _historical_' },
    { id: '#2210', icon: '⊟\uFE0E', text: 'Only 12 Outputs above this' },
...
export const MOCK_DEMO_NOTES: Record<number, string> = {
    ...
    500:  'Round Output number, always gets attention',
    555:  'Triple digit repeat — _collectors love these_',
    777:  'Lucky number Output, priced at `0.4 ETH` floor ask',
