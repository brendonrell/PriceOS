...
export interface TokenDef {
    ...
    note?: string;
    /** Family tag — 'artcoin' marks the fxhash artcoin set so the whole
     *  family can be dealt as one hand ("artcoins"). */
    family?: 'artcoin';
}
...
/** The artcoin family, in registry order — the "artcoins" hand deals these. */
export const ARTCOINS: readonly TokenDef[] = TOKENS.filter((t) => t.family === 'artcoin');
