...
export const LADDER_ACHIEVEMENTS: readonly Achievement[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────
  { id: 'l_score_2500', name: 'Quarter Way', blurb: 'Reach 2,500 PriceScore.', points: 90, category: 'rank', trigger: 'score.total>=2500' },
  { id: 'l_score_7500', name: 'Within Reach', blurb: 'Reach 7,500 PriceScore. The hammer is in sight.', points: 250, category: 'rank', trigger: 'score.total>=7500' },
