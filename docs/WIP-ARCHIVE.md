...
> The `docs/WIP.md` baton keeps only what is IN FLIGHT. Everything below is the
> shipped record, oldest sessions at the bottom. **⛔ Every lock in here still
> binds** — a decision does not stop being settled because its session scrolled
> off the baton. The baton carries a one-line index of these locks; when one is
> relevant, come here and read the full entry before touching that surface.
...
## ✅ SHIPPED 2026-08-01 (night) — menu lag hunt · pings cadence · keychains · stickers persistence
